...
// For PatternSeacher
case class TickerProperty(ticker_id :Int, bar_width_sec :Int,deepCntPattern :Int, session: Session, alogger: Logger) extends PatternSearcherCommon(session,alogger){
  ...
  def getFutAnalResultsByTsEnds(session: Session, tsEndCollect : java.util.List[java.lang.Long]/*List[java.lang.Long]*/) /*:Seq[BarFutAnalRes]*/ = {
